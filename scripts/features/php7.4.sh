...
if [ -f /home/$WSL_USER_NAME/.homely-features/php74 ]
then
...
touch /home/$WSL_USER_NAME/.homely-features/php74
...
sed -i "s/group = www-data/group = $WSL_USER_NAME/" /etc/php/7.4/fpm/pool.d/www.conf
sed -i "s/listen\.owner.*/listen.owner = $WSL_USER_NAME/" /etc/php/7.4/fpm/pool.d/www.conf
sed -i "s/listen\.group.*/listen.group = $WSL_USER_NAME/" /etc/php/7.4/fpm/pool.d/www.conf
