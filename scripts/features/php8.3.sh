...
if [ -f /home/$WSL_USER_NAME/.homely-features/php83 ]
then
...
touch /home/$WSL_USER_NAME/.homely-features/php83
...
php8.3-zip php8.3-imagick

# php8.3-xdebug php8.3-xmlrpc php8.3-memcached php8.3-redis
