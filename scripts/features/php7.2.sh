...
if [ -f /home/$WSL_USER_NAME/.homely-features/php72 ]
then
...
touch /home/$WSL_USER_NAME/.homely-features/php72
...
php7.2-fpm php7.2-gd php7.2-gmp php7.2-imap php7.2-interbase php7.2-intl php7.2-json php7.2-ldap php7.2-mbstring \
php7.2-mysql php7.2-odbc php7.2-opcache php7.2-pgsql php7.2-phpdbg php7.2-pspell php7.2-readline php7.2-recode \
php7.2-snmp php7.2-soap php7.2-sqlite3 php7.2-sybase php7.2-tidy php7.2-xdebug php7.2-xml php7.2-xmlrpc php7.2-xsl \
php7.2-zip php7.2-memcached php7.2-redis
...
sed -i "s/group = www-data/group = $WSL_USER_NAME/" /etc/php/7.2/fpm/pool.d/www.conf
sed -i "s/listen\.owner.*/listen.owner = $WSL_USER_NAME/" /etc/php/7.2/fpm/pool.d/www.conf
sed -i "s/listen\.group.*/listen.group = $WSL_USER_NAME/" /etc/php/7.2/fpm/pool.d/www.conf
