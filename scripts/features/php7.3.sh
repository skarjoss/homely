...
if [ -f /home/$WSL_USER_NAME/.homely-features/php73 ]
then
...
touch /home/$WSL_USER_NAME/.homely-features/php73
...
php7.3-zip php7.3-memcached php7.3-redis php7.3-imagick
...
sed -i "s/group = www-data/group = $WSL_USER_NAME/" /etc/php/7.3/fpm/pool.d/www.conf
sed -i "s/listen\.owner.*/listen.owner = $WSL_USER_NAME/" /etc/php/7.3/fpm/pool.d/www.conf
sed -i "s/listen\.group.*/listen.group = $WSL_USER_NAME/" /etc/php/7.3/fpm/pool.d/www.conf
